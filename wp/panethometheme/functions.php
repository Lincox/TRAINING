...
function blog()
{
  ...
  register_post_type('blog', $args);//tao post type voi slut (duong dan) la post va tham so la $arg
}

// make taxonomy for My blog
...
//Remove html's margin of defaul wordpress
show_admin_bar(false); 

//wrap the content by a p
add_action('the_content','ravs_content_p');
 function ravs_content_p( $content ){
  return '<p>'.$content.'</p>';
 }
