...
/*	function addAttachment($address,$name="") {
	...
	function setSubject($subject){
		// $this->Subject = $this->encodeMimeHeader(mb_convert_encoding($subject,"JIS",$this->in_enc)); // cmt out 170104
	...
	*/
	...
	function setFromName($fromname){
		// $this->FromName = $this->encodeMimeHeader(mb_convert_encoding($fromname,"JIS",$this->in_enc)); // cmt out 170104
	...
	function setBody($body){
		// $this->Body = mb_convert_encoding($body,"JIS",$this->in_enc); // cmt out 170104
		$this->Body = $body;
		$this->AltBody = "";
		$this->IsHtml(false);
	}
	...
	function setHtmlBody($htmlbody){
		// $this->Body = mb_convert_encoding($htmlbody,"JIS",$this->in_enc); // cmt out 170104
		$this->Body = $htmlbody;
		$this->IsHtml(true);
	}
	...
	function setAltBody($altbody){
		// $this->AltBody = mb_convert_encoding($altbody,"JIS",$this->in_enc); // cmt out 170104
