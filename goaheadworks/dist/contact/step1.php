...
<p class="taC t20b0"><img src="<?php echo APP_ASSETS; ?>images/form/img_step01.png" width="630" height="39" alt=""/></p>
	...
	<table class="tableContact" cellspacing="0">
			...
			<tr>
				...
				<td>
                <p class="floatL">
                    <input placeholder="例) 000-000-0000" type="tel"  name="tel" id="tel">
                </p>
			...
			<tr>
				...
				<td>
                <p class="floatL">
                    <input placeholder="例) 000-000-0000" type="tel"  name="fax" id="fax">
                </p>
				<p class="floatL ml10">※半角数字でご記入ください。</p>
                </td>
			</tr>
			...
			<tr>
				...
				<td>
                    <p><input placeholder="例) xxxxx@sample.co.jp" type="email" name="email" id="email">
                    </p>
					<p class="mt10">
                        <input placeholder="例) xxxxx@sample.co.jp" type="email"  name="cemail" id="cemail" value="">
                    </p>
				</td>
			</tr>
			<tr>
        ...
        <p class="t30b20">
        	<button name="action" value="confirm"><span>入力内容を確認する</span></button>
		</p>
    	</div>
